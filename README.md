...
- [Helius API Key](https://www.helius.dev/) (free tier available)
...
Enable and start:
```bash
sudo systemctl enable solana-dashboard
...
- [Helius](https://www.helius.dev/) for providing reliable Solana RPC infrastructure
